    ...
    const howItWorks = [
        {
            ...
            "description": "Start by filling out our 'Get Offer' form with your details. Share information about your moving or transport needs, such as the type of items, pickup location, and destination. This helps us tailor a solution that best fits your requirements."
        },
        {
            "stepNumber": "  2nd Step",
            "title": "Select Your Services",
            "description": "Once you receive a quote, choose the services you need. Whether it's just a transport vehicle, a team of professional helpers, or a complete moving package, we provide flexible options to suit your budget and preferences."
        },
        {
            "stepNumber": "3rd Step",
            "title": "Schedule Your Move",
            "description": "Pick a convenient date and time for your move. Our team ensures timely arrivals and works around your schedule to make the process smooth and hassle-free."
        },
        {
            "stepNumber": "4th Step",
            "title": "Sit Back and Relax",
            "description": "With everything planned and scheduled, you can rest easy. Our expert team will handle all the heavy lifting, ensuring your belongings are transported safely and efficiently to their destination."
        }
    ]
        ...
        <section className=" relative">
            <div className="w-full max-w-7xl px-4 lg:p-5 mx-auto">
                <div className="w-full flex-col justify-start items-center lg:gap-12 gap-8 inline-flex">
                    <div className="w-full flex-col justify-start items-center gap-3 flex mt-4">
