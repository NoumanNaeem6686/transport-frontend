...
export const TransportPage: React.FC = () => {
    return (
        <div className="flex flex-col">
            <img src="/Frame 427319221.png" alt="" className='absolute w-full' />
            <div
                ...
                <div className="flex z-0 flex-col justify-between max-w-full min-h-[348px] lg:w-[686px]">
                    <h1 className="text-6xl font-bold text-sky-800 leading-[73px] max-md:max-w-full max-md:text-4xl max-md:leading-[58px]">
                        <span className="text-zinc-800">Moving</span> Doesn't Have to{' '}
                    ...
                    <div className="flex gap-3 items-center self-start mt-8 text-base font-medium text-center">
                        <Link href="get-offer">
                            <button className="gap-2.5 hover:scale-105 transition-all duration-250 self-stretch px-9 py-3.5 my-auto w-48 text-white bg-sky-800 rounded min-h-[46px] max-md:px-5">
                                Get Offer
                            </button>
                        </Link>
                        <Link href="book-now">
                            <button className="gap-2.5 self-stretch hover:scale-105 transition-all duration-250 px-9 py-3.5 my-auto w-48 text-sky-800 rounded border border-sky-800 border-solid min-h-[46px] max-md:px-5">
                                Book Now
                            </button>
                        </Link>
                    </div>
                </div>
                <div className="flex absolute z-0 flex-col max-w-full font-semibold text-white right-[77px] top-[140px] w-[187px]">
