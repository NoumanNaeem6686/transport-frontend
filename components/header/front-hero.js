      ...
      <div className="container">
        <div className="front-hero">
          <div className="front-hero-section front-hero-text">
            ...
            <p>
              High performance Windows VPS and Linux VPS backed by enterprise
              hardware, 10G network and excellent 24/7 customer care.
            </p>
            <div className="flex-container">
              <Link href="/vps/kvm-vps">
                <a className="button button-primary">Get Offer</a>
              </Link>
              <Link href="/dedicated">
                <a className="button button-secondary">Book Service</a>
              </Link>
            </div>
          </div>
          {/* front-hero-text */}
